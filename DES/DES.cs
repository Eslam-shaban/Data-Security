...
namespace SecurityLibrary.DES
{
    ...
    public class DES : CryptographicTechnique
    {
        public override string Decrypt(string cipherText, string key)
        {
            ...
            int index = 0;
            while (index < bicipher.Length / 2)
            {
                LM = LM + bicipher[index];
                RM = RM + bicipher[index + bicipher.Length / 2];
                index++;
            }
            ...
            //C and D
            string c = t_mpk.Substring(0, 28);
            string d = t_mpk.Substring(28, 28);
            ...
            {
                {
                    ...
                    {
                        E_xor_k = E_xor_k + (N_keys[N_keys.Count - 1 - index][g] ^ Ebit[g]).ToString();
                    }

                    for (int z = 0; z < E_xor_k.Length; z = z + 6)
                    {
                        t = "";
                        for (int y = z; y < 6 + z; y++)
                        {
                            if (6 + z <= E_xor_k.Length)
                                t = t + E_xor_k[y];
                        }
        ...
        public override string Encrypt(string plainText, string key)
        {
            ...
            string RM = "";
            int index = 0;
            while (index < biplain.Length / 2)
            {

                LM = LM + biplain[index];
                RM = RM + biplain[index + biplain.Length / 2];
                index++;
            }
            ...
            while (index < 16)
            {

                {
                    ...
                    for (int g = 0; g < Ebit.Length; g++)
                    {
                        E_xor_k = E_xor_k + (N_keys[index][g] ^ Ebit[g]).ToString();
                    }
